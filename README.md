...
### Check the "Samples" folder for examples of how to use PIB to initialize OpenGLES 2.0 with EGL or GLFW.<br>Yes. We have a GLFW3 port for the vita. You can built it here: https://github.com/SonicMastr/glfw-vita
